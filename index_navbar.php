...
<head>
    ...
    <style>
        ...
        .nav-link {
        font-weight: bold;
        color: #0f48a3; /* Adjust the color to your preference */
    ...
    ?>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <!-- Search Form -->
                <li class="nav-item">
                    <form class="form-inline" method="POST" action="./customer/search_process.php">
            ...
            <ul class="navbar-nav ml-auto">
                <!-- Navigation Buttons -->
                <a  href="./customer/cart.php" style="text-decoration: none; color:black; ">My cart<i class="fa" style="font-size:24px">&#xf07a;</i></a>
    <span>  <?php
                ...
                <li class="nav-item">
                    <a href="./customer/products.php" class="btn btn-success ml-2">Products</a>
                </li>
                <li class="nav-item">
                    <a href="./customer/categories.php" class="btn btn-success ml-2">Category</a>
                </li>
                <li class="nav-item">
                    <a href="./customer/offer.php" class="btn btn-success ml-2">Offer Zone</a>
                </li>
                <li class="nav-item">
                    <a href="./customer/profile.php" class="btn btn-success ml-2">My Profile</a>
                </li>
                <li class="nav-item">
                    <a href="./customer/about.php" class="btn btn-success ml-2">About Us</a>
                </li>
