 ...
 <div id="homeSlider" class="carousel slide" data-ride="carousel">
    ...
    <script>
        $(document).ready(function () {
            ...
            }, 3000); // Change the time to slide automatically
        });
    </script>
...
<body>
    ...
    <div class="final-offer-price">&#x20B9;<?php echo htmlspecialchars($row['offer_price']); ?></div>
                            ...
                            <a href="./customer/view_product.php?product_id=<?php echo $row['product_id']; ?>" class="btn btn-primary btn-block">View Product</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <img src="./images/<?php echo htmlspecialchars($row['cat_image']); ?>" style="height: 200px;" class="card-img-top" alt="Category Image">
                        ...
                        <h2 class="card-title stylish-text"><?php echo htmlspecialchars($row['cat_name']); ?></h2>
                            ...
                            <a href="./customer/product_categories.php?cat_id=<?php echo $row['cat_id']; ?>" class="btn btn-primary btn-block">View Products</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-links">
                <a href="./customer/contact.php" class="link1">Contact Us</a>
                <a href="./customer/products.php" class="link1">Products</a>
                <a href="./customer/delivery.php" class="link4">Delivery Policy</a>
                <a href="./customer/terms.php" class="link4">Terms & Conditions</a>
                <a href="./customer/privacy.php" class="link3">Privacy Policy</a>
                <a href="./customer/returns.php">Returns</a>
            </div>
        </div>
